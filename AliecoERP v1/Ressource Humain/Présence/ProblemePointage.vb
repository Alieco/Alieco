        ...
        Try
            ...
            Else
                If sql.VerifiyConnection = True Then
                    ...
                    sql.RunQuery("SELECT employes.Matricule, Nom, Prénom, Direction,Fonction, date_pointage, Entree1,Sortie1, Entree2,Sortie2,Entree3,Sortie3, absence, HeureSupplementaire, Motif FROM presence_pointage, Employes WHERE Employes.Matricule=presence_pointage.Matricule and (date_pointage between  '" & du.Value.ToString("yyyy-MM-dd") & "' and '" & au.Value.ToString("yyyy-MM-dd") & "') and ((presence_pointage.Entree1<>'00:00:00' and presence_pointage.Sortie1='00:00:00' ) or (presence_pointage.Entree2<>'00:00:00' and presence_pointage.Sortie2='00:00:00') or (presence_pointage.Entree3<>'00:00:00' and presence_pointage.Sortie3 ='00:00:00')or (presence_pointage.Entree1='00:00:00' and presence_pointage.Sortie1<>'00:00:00' ) or (presence_pointage.Entree2='00:00:00' and presence_pointage.Sortie2<>'00:00:00') or (presence_pointage.Entree3='00:00:00' and presence_pointage.Sortie3 <>'00:00:00')) ")
