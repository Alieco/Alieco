        ...
        If matri <> "" Then
            ...
            If myDR.HasRows Then
                While myDR.Read
                    ...
                    If myDR("Date_fin_de_contrat").ToString = "" Or myDR("Date_fin_de_contrat").ToString = "00:00:00" Then
                        RichEditControl1.Document.ReplaceAll("[DS]", "A ce jour", API.Native.SearchOptions.CaseSensitive)
                    Else
                        RichEditControl1.Document.ReplaceAll("[DS]", myDR("Date_fin_de_contrat").ToString("dd/MM/yyyy"), API.Native.SearchOptions.CaseSensitive)
                    End If
